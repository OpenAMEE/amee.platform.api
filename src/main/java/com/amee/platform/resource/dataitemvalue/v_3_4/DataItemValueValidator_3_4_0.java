...
public class DataItemValueValidator_3_4_0 extends BaseValidator implements DataItemValueResource.DataItemValueValidator {
    ...
    protected void addValue() {
        ...
        if (ivd.isDouble()) {
            ...
            // Add the editor.
            add(Double.class, "value", new DataItemValueEditor(ivd));
            ...
            // Add the editor.
            add(Integer.class, "value", new DataItemValueEditor(ivd));
        } else {
            // String values.
            // Allow parameter for this ItemValueDefinition.
            allowedFields.add("value");
            ...
            add(new ValidationSpecification()
                    ...
                    .setAllowEmpty(true));
            // Add the editor.
            add(String.class, "value", new DataItemValueEditor(ivd));
        }
    }
