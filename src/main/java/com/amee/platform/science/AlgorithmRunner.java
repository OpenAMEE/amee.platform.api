...
public class AlgorithmRunner {
     ...
     */
    public Amounts evaluate(Algorithm algorithm, Map<String, Object> values) throws ScriptException {
        ...
        if (result != null) {
            amounts.putAmount(DEFAULT_TYPE, DEFAULT_UNIT, DEFAULT_PER_UNIT, Double.parseDouble(result.toString()));
