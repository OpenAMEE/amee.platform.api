...
class ReturnValueDefinitionIT extends BaseApiTest {
    ...
    @Test
    void removeReturnValueDefintionJson() {
        ...
        def response = client.delete(path: "/3.1/definitions/11D3548466F2/returnvalues/${location}")
        assertEquals 200, response.status

        // We should get a 404 here
        try {
            response = client.get(path: "/3.1/definitions/11D3548466F2/returnvalues/${location}")
